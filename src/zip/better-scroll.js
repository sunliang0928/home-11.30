...
!function (t, i) {
  ...
  var f = r("transform"),
      g = e && r("perspective") in o,
      v = e && ("ontouchstart" in window || i),
      y = !1 !== f,
      x = e && r("transition") in o,
      S = {
    transform: f,
  ...
  var I = e ? window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || function (t) {
    return window.setTimeout(t, (t.interval || 100 / 60) / 2);
  } : D,
      k = e ? window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.oCancelAnimationFrame || function (t) {
  ...
  A.prototype.handleEvent = function (t) {
    ...
    if (!i || this.visible) {
      var s = t ? 250 : 500;
      t = t ? "1" : "0", this.wrapperStyle[S.transitionDuration] = s + "ms", clearTimeout(this.fadeTimeout), this.fadeTimeout = setTimeout(function () {
    ...
    if ("vertical" === this.direction) {
      ...
      this.y = t, this.scroller.options.useTransform ? this.indicatorStyle[S.transform] = "translateY(" + t + "px)" + this.scroller.translateZ : this.indicatorStyle.top = t + "px";
    } else {
      ...
      this.x = s, this.scroller.options.useTransform ? this.indicatorStyle[S.transform] = "translateX(" + s + "px)" + this.scroller.translateZ : this.indicatorStyle.left = s + "px";
    }
  }, A.prototype.transitionTime = function () {
    var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0;
    this.indicatorStyle[S.transitionDuration] = t + "ms";
  }, A.prototype.transitionTimingFunction = function (t) {
    this.indicatorStyle[S.transitionTimingFunction] = t;
    ...
    if (this.initiated) {
      this.initiated = !1, t.preventDefault(), t.stopPropagation(), this._handleMoveEvents(p);
      var i = this.scroller.options.snap;

      if (i) {
        var e = i.speed,
            s = i.easing,
            o = void 0 === s ? P.bounce : s,
  ...
  }, A.prototype._shouldShow = function () {
  ...
  function G(t, i) {
    this.wrapper = "string" == typeof t ? document.querySelector(t) : t, this.wrapper || z("Can not resolve the wrapper DOM."), this.scroller = this.wrapper.children[0], this.scroller || z("The wrapper need at least one child element to be scroller."), this.scrollerStyle = this.scroller.style, this._init(t, i);
  }

  return j.prototype.onScroll = function () {
    ...
    for (var t, i = void 0, e = this.items.length, s = 0; s < e; s++) {
      var o = this.items[s].node,
          n = this.items[s].data;
      o && !Z(o) || n || (i || (i = s), o && this.scrollerEl.removeChild(o));
    }
    ...
    for (var t = [], i = 0; i < this.items.length; i++) {
      if (i !== this.firstAttachedItem) {
        ...
        e && (Z(e) ? (this.tombstones.push(e), this.tombstones[this.tombstones.length - 1].style.display = "none") : t.push(e)), this.items[i].node = null;
    ...
    this.scroller.maxScrollY = -(t - this.wrapperEl.offsetHeight + (this.hasMore ? 2e3 : 0)), setTimeout(function () {
      for (var t in e) {
        var i = e[t];
  ...
  }, (O = G).prototype._init = function (t, i) {
  ...
  }, O.prototype._initExtFeatures = function () {
  ...
  }, O.prototype._watchTransition = function () {
  ...
  }, O.prototype._handleAutoBlur = function () {
    this.on("scrollStart", function () {
      var t = document.activeElement;
      !t || "INPUT" !== t.tagName && "TEXTAREA" !== t.tagName || t.blur();
    });
  }, O.prototype._initDOMObserver = function () {
    var n = this;
  ...
  }, O.prototype._shouldNotRefresh = function () {
  ...
  }, O.prototype._checkDOMUpdate = function () {
    var s = b(this.scroller),
        o = s.width,
        n = s.height;
    (function e() {
      var t = this;
      setTimeout(function () {
        (function () {
          if (!this.destroyed) {
            var t = (s = b(this.scroller)).width,
                i = s.height;
            o === t && n === i || this.refresh(), o = t, n = i, e.call(this);
          }
        }).call(t);
      }, 1e3);
    }).call(this);
    ...
    s ? (this.items = this.scroller.children, this.options.itemHeight = this.itemHeight = this.items.length ? this.scrollerHeight / this.items.length : 0, void 0 === this.selectedIndex && (this.selectedIndex = s.selectedIndex || 0), this.options.startY = -this.selectedIndex * this.itemHeight, this.maxScrollX = 0, this.maxScrollY = -this.itemHeight * (this.items.length - 1)) : (this.maxScrollX = this.wrapperWidth - this.scrollerWidth, this.options.infinity || (this.maxScrollY = this.wrapperHeight - this.scrollerHeight), this.maxScrollX < 0 ? (this.maxScrollX -= this.relativeX, this.minScrollX = -this.relativeX) : 1 < this.scale && (this.maxScrollX = this.maxScrollX / 2 - this.relativeX, this.minScrollX = this.maxScrollX), this.maxScrollY < 0 ? (this.maxScrollY -= this.relativeY, this.minScrollY = -this.relativeY) : 1 < this.scale && (this.maxScrollY = this.maxScrollY / 2 - this.relativeY, this.minScrollY = this.maxScrollY)), this.hasHorizontalScroll = this.options.scrollX && this.maxScrollX < this.minScrollX, this.hasVerticalScroll = this.options.scrollY && this.maxScrollY < this.minScrollY, this.hasHorizontalScroll || (this.maxScrollX = this.minScrollX, this.scrollerWidth = this.wrapperWidth), this.hasVerticalScroll || (this.maxScrollY = this.minScrollY, this.scrollerHeight = this.wrapperHeight), this.endTime = 0, this.directionX = 0, this.directionY = 0, this.wrapperOffset = u(this.wrapper), this.trigger("refresh"), !this.scaled && this.resetPosition();
  }, O.prototype.enable = function () {
    this.enabled = !0;
  }, O.prototype.disable = function () {
    this.enabled = !1;
  }, (C = G).prototype._start = function (t) {
    var i = T[t.type];

    if ((1 === i || 0 === t.button) && !(!this.enabled || this.destroyed || this.initiated && this.initiated !== i)) {
      this.initiated = i, this.options.preventDefault && !_(t.target, this.options.preventDefaultException) && t.preventDefault(), this.options.stopPropagation && t.stopPropagation(), this.moved = !1, this.distX = 0, this.distY = 0, this.directionX = 0, this.directionY = 0, this.movingDirectionX = 0, this.movingDirectionY = 0, this.directionLocked = 0, this._transitionTime(), this.startTime = w(), this.options.wheel && (this.target = t.target), this.stop();
    ...
    if (this.enabled && !this.destroyed && T[t.type] === this.initiated) {
      this.initiated = !1, this.options.preventDefault && !_(t.target, this.options.preventDefaultException) && t.preventDefault(), this.options.stopPropagation && t.stopPropagation(), this.trigger("touchEnd", {
        x: this.x,
        y: this.y
      ...
      var i = Math.round(this.x),
          ...
          s = i - this.absStartX,
          o = e - this.absStartY;
      if (this.directionX = 0 < s ? -1 : s < 0 ? 1 : 0, this.directionY = 0 < o ? -1 : o < 0 ? 1 : 0, !this.options.pullDownRefresh || !this._checkPullDown()) if (this._checkClick(t)) this.trigger("scrollCancel");else if (!this.resetPosition(this.options.bounceTime, P.bounce)) {
        ...
        if (this._events.flick && n < this.options.flickLimitTime && r < this.options.flickLimitDistance && h < this.options.flickLimitDistance) this.trigger("flick");else {
          ...
          if (this.options.momentum && n < this.options.momentumLimitTime && (h > this.options.momentumLimitDistance || r > this.options.momentumLimitDistance)) {
            ...
            var m = -1 === this.directionX && p || 1 === this.directionX && d ? this.wrapperWidth : 0,
                ...
                g = this.hasHorizontalScroll ? E(this.x, this.startX, n, this.maxScrollX, this.minScrollX, m, this.options) : {
              destination: i,
              duration: 0
            },
                v = this.hasVerticalScroll ? E(this.y, this.startY, n, this.maxScrollY, this.minScrollY, f, this.options) : {
              destination: e,
              duration: 0
            };
          ...
          if (this.options.snap) {
            ...
            this.currentPage = x, a = this.options.snapSpeed || Math.max(Math.max(Math.min(Math.abs(i - x.x), 1e3), Math.min(Math.abs(e - x.y), 1e3)), 300), i = x.x, e = x.y, this.directionX = 0, this.directionY = 0, y = this.options.snap.easing || P.bounce;
          }

          if (i !== this.x || e !== this.y) return (i > this.minScrollX || i < this.maxScrollX || e > this.minScrollY || e < this.maxScrollY) && (y = P.swipeBounce), void this.scrollTo(i, e, a, y);
    ...
    if (this.options.wheel) {
      if (this.target && this.target.className === this.options.wheel.wheelWrapperClass) {
        var n = Math.abs(Math.round(this.y / this.itemHeight)),
            r = Math.round((this.pointY + m(this.wrapper).top - this.wrapperHeight / 2) / this.itemHeight);
        this.target = this.items[n + r];
      }

      return this.scrollToElement(this.target, this.options.wheel.adjustTime || 400, !0, !0, P.swipe), !0;
    }
    ...
    if (h && this.lastClickTime) {
      var l = h.delay,
          c = void 0 === l ? 300 : l;
      w() - this.lastClickTime < c && (a = !0, Y(t, "dblclick"));
    }

    return this.options.tap && (i = t, e = this.options.tap, (s = document.createEvent("Event")).initEvent(e, !0, !0), s.pageX = i.pageX, s.pageY = i.pageY, i.target.dispatchEvent(s)), this.options.click && !_(t.target, this.options.preventDefaultException) && Y(t), this.lastClickTime = a ? null : w(), !0;
    ...
    k(this.probeTimer), this.probeTimer = I(function t() {
    ...
    t.target === this.scroller && this.isInTransition && (this._transitionTime(), (!this.pulling || 1 === this.movingDirectionY) && !this.resetPosition(this.options.bounceTime, P.bounce) && (this.isInTransition = !1, 3 !== this.options.probeType && this.trigger("scrollEnd", {
      x: this.x,
      y: this.y
    })));
  }, C.prototype._translate = function (t, i, e) {
    if (H(!c(t) && !c(i), "Translate x or y is null or undefined."), c(e) && (e = this.scale), this.options.useTransform ? this.scrollerStyle[S.transform] = "translate(" + t + "px," + i + "px) scale(" + e + ")" + this.translateZ : (t = Math.round(t), i = Math.round(i), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = i + "px"), this.options.wheel) for (var s = this.options.wheel.rotate, o = void 0 === s ? 25 : s, n = 0; n < this.items.length; n++) {
  ...
  }, C.prototype._animate = function (r, h, a, l) {
    var c = this,
        p = this.x,
        d = this.y,
        u = this.lastScale,
        ...
        f = w(),
        g = f + a;
    this.isAnimating = !0, k(this.animateTimer), function t() {
      var i = w();
      if (g <= i) return c.isAnimating = !1, c._translate(r, h, m), void (c.pulling || c.resetPosition(c.options.bounceTime) || c.trigger("scrollEnd", {
        x: c.x,
        y: c.y
      }));
      var e = l(i = (i - f) / a),
          ...
          o = (h - d) * e + d,
          n = (m - u) * e + u;
      c._translate(s, o, n), c.isAnimating && (c.animateTimer = I(t)), 3 === c.options.probeType && c.trigger("scroll", {
        x: c.x,
        y: c.y
      });
    }();
  }, C.prototype.scrollBy = function (t, i) {
    var e = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
        s = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : P.bounce;
    t = this.x + t, i = this.y + i, this.scrollTo(t, i, e, s);
  }, C.prototype.scrollTo = function (t, i) {
    var e = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
        s = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : P.bounce;
    this.isInTransition = this.options.useTransition && 0 < e && (t !== this.x || i !== this.y), !e || this.options.useTransition ? (this._transitionTimingFunction(s.style), this._transitionTime(e), this._translate(t, i), e && 3 === this.options.probeType && this._startProbe(), this.options.wheel && (i > this.minScrollY ? this.selectedIndex = 0 : i < this.maxScrollY ? this.selectedIndex = this.items.length - 1 : this.selectedIndex = Math.round(Math.abs(i / this.itemHeight)))) : this._animate(t, i, e, s.fn);
  }, C.prototype.scrollToElement = function (t, i, e, s, o) {
    ...
    var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0,
        i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : P.bounce,
        e = this.x,
        s = Math.round(e);
    ...
    } else !this.options.useTransition && this.isAnimating && (this.isAnimating = !1, k(this.animateTimer), this.trigger("scrollEnd", {
      x: this.x,
      y: this.y
    }), this.stopFromTransition = !0);
  ...
  }, (R = G).prototype._initSnap = function () {
    var m = this;
    this.currentPage = {};
    var t,
        i,
    ...
    "string" == typeof g && (g = this.scroller.querySelectorAll(g)), this.on("refresh", function () {
      if (m.pages = [], m.wrapperWidth && m.wrapperHeight && m.scrollerWidth && m.scrollerHeight) {
        ...
        if (g) for (h = g.length, l = -1; r < h; r++) {
          c = b(g[r]), (0 === r || c.left <= b(g[r - 1]).left) && (a = 0, l++), m.pages[a] || (m.pages[a] = []), e = Math.max(-c.left, m.maxScrollX), s = Math.max(-c.top, m.maxScrollY), o = e - Math.round(c.width / 2), n = s - Math.round(c.height / 2), m.pages[a][l] = {
            x: e,
            y: s,
            width: c.width,
            height: c.height,
      ...
      if (f.loop) {
        ...
        2 < t.length && (X(m.scroller, t[t.length - 1]), X(m.scroller, t[0]));
      }
    });
  }, R.prototype._checkSnapLoop = function () {
    var t = this.options.snap;
    t.loop && this.pages && this.pages.length && (1 < this.pages.length && (t._loopX = !0), this.pages[0] && 1 < this.pages[0].length && (t._loopY = !0), t._loopX && t._loopY && z("Loop does not support two direction at the same time."));
  }, R.prototype._nearestSnap = function (t, i) {
  ...
  }, R.prototype._goToPage = function (t) {
    var i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0,
        e = arguments[2],
        s = arguments[3],
        o = this.options.snap;

    if (o && this.pages && this.pages.length && (s = s || o.easing || P.bounce, t >= this.pages.length ? t = this.pages.length - 1 : t < 0 && (t = 0), this.pages[t])) {
  ...
  }, R.prototype.goToPage = function (t, i, e, s) {
  ...
  }, (U = G).prototype._initScrollbar = function () {
    var i = this,
    ...
    this.options.scrollX && (r = {
      ...
      fade: s,
      interactive: n
    }, this._insertScrollBar(r.el), this.indicators.push(new A(this, r))), this.options.scrollY && (r = {
      el: W("vertical"),
      direction: "vertical",
      fade: s,
      interactive: n
    }, this._insertScrollBar(r.el), this.indicators.push(new A(this, r))), this.on("refresh", function () {
  ...
  }, U.prototype._insertScrollBar = function (t) {
    this.wrapper.appendChild(t);
  }, U.prototype._removeScrollBars = function () {
    for (var t = 0; t < this.indicators.length; t++) {
      this.indicators[t].destroy();
    }
  }, (N = G).prototype._initPullDown = function () {
    ...
    var t = this.options.pullDownRefresh,
        ...
        s = t.stop,
        o = void 0 === s ? 40 : s;
    return !(-1 !== this.directionY || this.y < e) && (this.pulling || (this.pulling = !0, this.trigger("pullingDown")), this.scrollTo(this.x, o, this.options.bounceTime, P.bounce), this.pulling);
  }, N.prototype.finishPullDown = function () {
    this.pulling = !1, this.resetPosition(this.options.bounceTime, P.bounce);
    ...
    if (this.enabled) {
      ...
      d = this.x + Math.round(this.hasHorizontalScroll ? l : 0), u = this.y + Math.round(this.hasVerticalScroll ? c : 0), this.movingDirectionX = this.directionX = 0 < l ? -1 : l < 0 ? 1 : 0, this.movingDirectionY = this.directionY = 0 < c ? -1 : c < 0 ? 1 : 0, d > this.minScrollX ? d = this.minScrollX : d < this.maxScrollX && (d = this.maxScrollX), u > this.minScrollY ? u = this.minScrollY : u < this.maxScrollY && (u = this.maxScrollY), this.scrollTo(d, u, a, P.swipe), this.trigger("scroll", {
        x: this.x,
        y: this.y
      });
    }
  }, (V = G).prototype._initZoom = function () {
    var t = this.options.zoom,
        ...
        n = t.max,
        r = void 0 === n ? 4 : n;
    this.scale = Math.min(Math.max(e, o), r), this.setScale(this.scale), this.scrollerStyle[S.transformOrigin] = "0 0";
  }, V.prototype._zoomTo = function (t, i, e, s) {
    this.scaled = !0;
  ...
  }, V.prototype.zoomTo = function (t, i, e) {
  ...
  }, V.prototype._zoomEnd = function (t) {
    if (this.enabled && !this.destroyed && T[t.type] === this.initiated) {
  ...
  }, G.prototype._initInfinite = function () {
