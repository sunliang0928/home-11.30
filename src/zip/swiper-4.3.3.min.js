...
!function (e, t) {
  ...
  function $(e, t) {
    ...
    if (e) if ("string" == typeof e) {
      ...
      if (0 <= n.indexOf("<") && 0 <= n.indexOf(">")) {
        ...
        for (0 === n.indexOf("<li") && (o = "ul"), 0 === n.indexOf("<tr") && (o = "tbody"), 0 !== n.indexOf("<td") && 0 !== n.indexOf("<th") || (o = "tr"), 0 === n.indexOf("<tbody") && (o = "table"), 0 === n.indexOf("<option") && (o = "select"), (r = v.createElement(o)).innerHTML = n, s = 0; s < r.childNodes.length; s += 1) {
          i.push(r.childNodes[s]);
        }
      } else for (a = t || "#" !== e[0] || e.match(/[ .<>:~]/) ? (t || v).querySelectorAll(e.trim()) : [v.getElementById(e.trim().split("#")[1])], s = 0; s < a.length; s += 1) {
        a[s] && i.push(a[s]);
      }
    } else if (e.nodeType || e === N || e === v) i.push(e);else if (0 < e.length && e[0].nodeType) for (s = 0; s < e.length; s += 1) {
      i.push(e[s]);
    }
    return new l(i);
  }
  ...
  var t = {
    ...
    on: function on() {
      ...
      function o(e) {
        ...
        if (t) {
          ...
          if (i.indexOf(e) < 0 && i.unshift(e), $(t).is(r)) n.apply(t, i);else for (var s = $(t).parents(), a = 0; a < s.length; a += 1) {
            $(s[a]).is(r) && n.apply(s[a], i);
          }
        }
      }
    ...
    off: function off() {
      ...
      for (var o = s.split(" "), l = 0; l < o.length; l += 1) {
        for (var d = o[l], h = 0; h < this.length; h += 1) {
          var p = this[h],
              c = void 0;
          if (!a && p.dom7Listeners ? c = p.dom7Listeners[d] : a && p.dom7LiveListeners && (c = p.dom7LiveListeners[d]), c && c.length) for (var u = c.length - 1; 0 <= u; u -= 1) {
            var v = c[u];
    ...
    parent: function parent(e) {
      for (var t = [], i = 0; i < this.length; i += 1) {
        null !== this[i].parentNode && (e ? $(this[i].parentNode).is(e) && t.push(this[i].parentNode) : t.push(this[i].parentNode));
      }
    ...
    parents: function parents(e) {
      for (var t = [], i = 0; i < this.length; i += 1) {
        for (var s = this[i].parentNode; s;) {
          e ? $(s).is(e) && t.push(s) : t.push(s), s = s.parentNode;
        }
      }
    ...
    children: function children(e) {
      for (var t = [], i = 0; i < this.length; i += 1) {
        for (var s = this[i].childNodes, a = 0; a < s.length; a += 1) {
          e ? 1 === s[a].nodeType && $(s[a]).is(e) && t.push(s[a]) : 1 === s[a].nodeType && t.push(s[a]);
        }
      }
  ...
  var e,
    ...
    getTranslate: function getTranslate(e, t) {
      ...
      return N.WebKitCSSMatrix ? (6 < (s = r.transform || r.webkitTransform).split(",").length && (s = s.split(", ").map(function (e) {
        return e.replace(",", ".");
    ...
    extend: function extend() {
      ...
      for (var i = Object(e[0]), s = 1; s < e.length; s += 1) {
        ...
        if (null != a) for (var r = Object.keys(Object(a)), n = 0, o = r.length; n < o; n += 1) {
          ...
          void 0 !== d && d.enumerable && (B.isObject(i[l]) && B.isObject(a[l]) ? B.extend(i[l], a[l]) : !B.isObject(i[l]) && B.isObject(a[l]) ? (i[l] = {}, B.extend(i[l], a[l])) : i[l] = a[l]);
        }
      }
      ...
      X = (s = v.createElement("div"), {
    touch: N.Modernizr && !0 === N.Modernizr.touch || !!("ontouchstart" in N || N.DocumentTouch && v instanceof N.DocumentTouch),
    pointerEvents: !(!N.navigator.pointerEnabled && !N.PointerEvent),
    prefixedPointerEvents: !!N.navigator.msPointerEnabled,
    transition: (i = s.style, "transition" in i || "webkitTransition" in i || "MozTransition" in i),
    transforms3d: N.Modernizr && !0 === N.Modernizr.csstransforms3d || (e = s.style, "webkitPerspective" in e || "MozPerspective" in e || "OPerspective" in e || "MsPerspective" in e || "perspective" in e),
    flexbox: function () {
  ...
  a.prototype.on = function (e, t, i) {
    ...
    var r = this;
    return "function" != typeof a ? r : r.on(s, function e() {
    ...
    var i,
        ...
        a,
        r = this;
    return r.eventsListeners && (a = "string" == typeof e[0] || Array.isArray(e[0]) ? (i = e[0], s = e.slice(1, e.length), r) : (i = e[0].events, s = e[0].data, e[0].context || r), (Array.isArray(i) ? i : i.split(" ")).forEach(function (e) {
    ...
    var a = t.name || Object.keys(s.prototype.modules).length + "_" + B.now();
  ...
  var o = {
    ...
    updateSlides: function updateSlides() {
      ...
      if (void 0 !== i) {
        var y, x;
        "string" == typeof m && 0 <= m.indexOf("%") && (m = parseFloat(m.replace("%", "")) / 100 * i), this.virtualSize = -m, s ? o.css({
          marginLeft: "",
          marginTop: ""
        }) : o.css({
          marginRight: "",
          marginBottom: ""
        }), 1 < e.slidesPerColumn && (y = Math.floor(l / e.slidesPerColumn) === l / this.params.slidesPerColumn ? l : Math.ceil(l / e.slidesPerColumn) * e.slidesPerColumn, "auto" !== e.slidesPerView && "row" === e.slidesPerColumnFill && (y = Math.max(y, e.slidesPerView * e.slidesPerColumn)));

        for (var E, T = e.slidesPerColumn, S = y / T, C = S - (e.slidesPerColumn * S - l), M = 0; M < l; M += 1) {
          x = 0;
          var z = o.eq(M);
          ...
          if (1 < e.slidesPerColumn) {
            var k = void 0,
                P = void 0,
                $ = void 0;
            "column" === e.slidesPerColumnFill ? ($ = M - (P = Math.floor(M / T)) * T, (C < P || P === C && $ === T - 1) && ($ += 1) >= T && ($ = 0, P += 1), k = P + $ * y / T, z.css({
              "-webkit-box-ordinal-group": k,
              "-moz-box-ordinal-group": k,
              "-ms-flex-order": k,
              "-webkit-order": k,
              order: k
            })) : P = M - ($ = Math.floor(M / S)) * S, z.css("margin-" + (this.isHorizontal() ? "top" : "left"), 0 !== $ && e.spaceBetween && e.spaceBetween + "px").attr("data-swiper-column", P).attr("data-swiper-row", $);
          }

          if ("none" !== z.css("display")) {
            if ("auto" === e.slidesPerView) {
              var L = N.getComputedStyle(z[0], null),
                  I = z[0].style.transform,
                  D = z[0].style.webkitTransform;
              I && (z[0].style.transform = "none"), D && (z[0].style.webkitTransform = "none"), x = this.isHorizontal() ? z[0].getBoundingClientRect().width + parseFloat(L.getPropertyValue("margin-left")) + parseFloat(L.getPropertyValue("margin-right")) : z[0].getBoundingClientRect().height + parseFloat(L.getPropertyValue("margin-top")) + parseFloat(L.getPropertyValue("margin-bottom")), I && (z[0].style.transform = I), D && (z[0].style.webkitTransform = D), e.roundLengths && (x = Math.floor(x));
            } else x = (i - (e.slidesPerView - 1) * m) / e.slidesPerView, e.roundLengths && (x = Math.floor(x)), o[M] && (this.isHorizontal() ? o[M].style.width = x + "px" : o[M].style.height = x + "px");

            o[M] && (o[M].swiperSlideSize = x), p.push(x), e.centeredSlides ? (g = g + x / 2 + b / 2 + m, 0 === b && 0 !== M && (g = g - i / 2 - m), 0 === M && (g = g - i / 2 - m), Math.abs(g) < .001 && (g = 0), e.roundLengths && (g = Math.floor(g)), w % e.slidesPerGroup == 0 && d.push(g), h.push(g)) : (e.roundLengths && (g = Math.floor(g)), w % e.slidesPerGroup == 0 && d.push(g), h.push(g), g = g + x + m), this.virtualSize += x + m, b = x, w += 1;
          }
        }
        ...
        if (this.virtualSize = Math.max(this.virtualSize, i) + u, s && a && ("slide" === e.effect || "coverflow" === e.effect) && t.css({
        ...
        })), 1 < e.slidesPerColumn && (this.virtualSize = (x + e.spaceBetween) * y, this.virtualSize = Math.ceil(this.virtualSize / e.slidesPerColumn) - e.spaceBetween, this.isHorizontal() ? t.css({
          width: this.virtualSize + e.spaceBetween + "px"
        }) : t.css({
          height: this.virtualSize + e.spaceBetween + "px"
        }), e.centeredSlides)) {
          ...
          for (var O = 0; O < d.length; O += 1) {
            var A = d[O];
            e.roundLengths && (A = Math.floor(A)), d[O] < this.virtualSize + d[0] && E.push(A);
          }
        ...
        if (!e.centeredSlides) {
          ...
          for (var G = 0; G < d.length; G += 1) {
            var H = d[G];
            e.roundLengths && (H = Math.floor(H)), d[G] <= this.virtualSize - i && E.push(H);
          }

          d = E, 1 < Math.floor(this.virtualSize - i) - Math.floor(d[d.length - 1]) && d.push(this.virtualSize - i);
        }

        0 === d.length && (d = [0]), 0 !== e.spaceBetween && (this.isHorizontal() ? s ? o.css({
          marginLeft: m + "px"
        }) : o.css({
          marginRight: m + "px"
        }) : o.css({
          ...
          slidesGrid: h,
          slidesSizesGrid: p
        }), l !== n && this.emit("slidesLengthChange"), d.length !== v && (this.params.watchOverflow && this.checkOverflow(), this.emit("snapGridLengthChange")), h.length !== f && this.emit("slidesGridLengthChange"), (e.watchSlidesProgress || e.watchSlidesVisibility) && this.updateSlidesOffset();
      }
    },
      ...
      if (0 !== i.length) {
        ...
        for (var r = 0; r < i.length; r += 1) {
          ...
          if (t.watchSlidesVisibility) {
            ...
            (0 <= l && l < this.size || 0 < d && d <= this.size || l <= 0 && d >= this.size) && i.eq(r).addClass(t.slideVisibleClass);
          }
    ...
    updateProgress: function updateProgress(e) {
      ...
      var t = this.params,
          ...
          n = a,
          o = r;
      r = 0 === i ? a = !(s = 0) : (a = (s = (e - this.minTranslate()) / i) <= 0, 1 <= s), B.extend(this, {
        progress: s,
        isBeginning: a,
        isEnd: r
    ...
    updateActiveIndex: function updateActiveIndex(e) {
      ...
      if ((t = 0 <= a.indexOf(i) ? a.indexOf(i) : Math.floor(d / r.slidesPerGroup)) >= a.length && (t = a.length - 1), d !== n) {
    ...
    updateClickedSlide: function updateClickedSlide(e) {
      var t = this.params,
          i = $(e.target).closest("." + t.slideClass)[0],
          s = !1;
    ...
    setTranslate: function setTranslate(e, t) {
      var i = this.rtlTranslate,
          ...
          n = 0,
          o = 0;
      this.isHorizontal() ? n = i ? -e : e : o = e, s.roundLengths && (n = Math.floor(n), o = Math.floor(o)), s.virtualTranslate || (X.transforms3d ? a.transform("translate3d(" + n + "px, " + o + "px, 0px)") : a.transform("translate(" + n + "px, " + o + "px)")), this.previousTranslate = this.translate, this.translate = this.isHorizontal() ? n : o;
    ...
    slideTo: function slideTo(e, t, i, s) {
      ...
      c >= o.length && (c = o.length - 1), (h || n.initialSlide || 0) === (d || 0) && i && a.emit("beforeSlideChangeStart");
      var u,
          v = -o[c];
      if (a.updateProgress(v), n.normalizeSlideIndex) for (var f = 0; f < l.length; f += 1) {
      ...
      }), a.$wrapperEl[0].addEventListener("transitionend", a.onSlideToWrapperTransitionEnd), a.$wrapperEl[0].addEventListener("webkitTransitionEnd", a.onSlideToWrapperTransitionEnd))) : (a.setTransition(0), a.setTranslate(v), a.updateActiveIndex(r), a.updateSlidesClasses(), a.emit("beforeTransitionStart", t, s), a.transitionStart(i, u), a.transitionEnd(i, u)), !0);
    },
    ...
    slideToClickedSlide: function slideToClickedSlide() {
      ...
      if (i.loop) {
        ...
        e = parseInt($(t.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? r < t.loopedSlides - a / 2 || r > t.slides.length - t.loopedSlides + a / 2 ? (t.loopFix(), r = s.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), B.nextTick(function () {
          t.slideTo(r);
        })) : t.slideTo(r) : r > t.slides.length - a ? (t.loopFix(), r = s.children("." + i.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), B.nextTick(function () {
          t.slideTo(r);
        })) : t.slideTo(r);
      } else t.slideTo(r);
    }
    ...
    loopCreate: function loopCreate() {
      ...
      if (e.loopFillGroupWithBlank) {
        ...
        if (i !== e.slidesPerGroup) {
          for (var r = 0; r < i; r += 1) {
            var n = $(v.createElement("div")).addClass(e.slideClass + " " + e.slideBlankClass);
            t.append(n);
          }
      ...
      for (var h = o.length - 1; 0 <= h; h -= 1) {
        t.prepend($(o[h].cloneNode(!0)).addClass(e.slideDuplicateClass));
      }
    },
    loopFix: function loopFix() {
      ...
      i < a ? (e = s.length - 3 * a + i, e += a, this.slideTo(e, 0, !1, !0) && 0 !== d && this.setTranslate((l ? -this.translate : this.translate) - d)) : ("auto" === t.slidesPerView && 2 * a <= i || i >= s.length - a) && (e = -s.length + i + a, e += a, this.slideTo(e, 0, !1, !0) && 0 !== d && this.setTranslate((l ? -this.translate : this.translate) - d)), this.allowSlidePrev = r, this.allowSlideNext = n;
    },
    ...
    addSlide: function addSlide(e, t) {
      ...
      if (e <= 0) this.prependSlide(t);else if (r <= e) this.appendSlide(t);else {
        ...
        s.loop && this.loopCreate(), s.observer && X.observer || this.update(), s.loop ? this.slideTo(n + this.loopedSlides, 0, !1) : this.slideTo(n, 0, !1);
      }
    },
    removeSlide: function removeSlide(e) {
      ...
      t.loop && this.loopCreate(), t.observer && X.observer || this.update(), t.loop ? this.slideTo(r + this.loopedSlides, 0, !1) : this.slideTo(r, 0, !1);
    },
  ...
  var g,
    ...
    attachEvents: function attachEvents() {
      ...
      this.onTouchStart = function (e) {
        ...
        if (!this.animating || !i.preventIntercationOnTransition) {
          var a = e;
          if (a.originalEvent && (a = a.originalEvent), t.isTouchEvent = "touchstart" === a.type, (t.isTouchEvent || !("which" in a) || 3 !== a.which) && (!t.isTouched || !t.isMoved)) if (i.noSwiping && $(a.target).closest(i.noSwipingSelector ? i.noSwipingSelector : "." + i.noSwipingClass)[0]) this.allowClick = !0;else if (!i.swipeHandler || $(a).closest(i.swipeHandler)[0]) {
            ...
            if (!f.ios || f.cordova || !i.iOSEdgeSwipeDetection || !(r <= i.iOSEdgeSwipeThreshold || r >= N.screen.width - i.iOSEdgeSwipeThreshold)) {
              if (B.extend(t, {
                isTouched: !0,
                isMoved: !1,
                ...
                isScrolling: void 0,
                startMoving: void 0
              }), s.startX = r, s.startY = n, t.touchStartTime = B.now(), this.allowClick = !0, this.updateSize(), this.swipeDirection = void 0, 0 < i.threshold && (t.allowThresholdMove = !1), "touchstart" !== a.type) {
                var o = !0;
                $(a.target).is(t.formElements) && (o = !1), v.activeElement && $(v.activeElement).is(t.formElements) && v.activeElement !== a.target && v.activeElement.blur(), o && this.allowTouchMove && a.preventDefault();
              }
        ...
        if (r.originalEvent && (r = r.originalEvent), t.isTouched) {
          if (!t.isTouchEvent || "mousemove" !== r.type) {
            var n = "touchmove" === r.type ? r.targetTouches[0].pageX : r.pageX,
                o = "touchmove" === r.type ? r.targetTouches[0].pageY : r.pageY;
            if (r.preventedByNestedSwiper) return s.startX = n, void (s.startY = o);
            ...
            if (t.isTouchEvent && v.activeElement && r.target === v.activeElement && $(r.target).is(t.formElements)) return t.isMoved = !0, void (this.allowClick = !1);
        ...
        if (t.allowClick && (t.updateClickedSlide(d), t.emit("tap", d), c < 300 && 300 < p - i.lastClickTime && (i.clickTimeout && clearTimeout(i.clickTimeout), i.clickTimeout = B.nextTick(function () {
          t && !t.destroyed && t.emit("click", d);
        }, 300)), c < 300 && p - i.lastClickTime < 300 && (i.clickTimeout && clearTimeout(i.clickTimeout), t.emit("doubleTap", d))), i.lastClickTime = B.now(), B.nextTick(function () {
        ...
        if (i.isTouched = !1, i.isMoved = !1, i.startMoving = !1, h = s.followFinger ? r ? t.translate : -t.translate : -i.currentTranslate, s.freeMode) {
          ...
          if (s.freeModeMomentum) {
            if (1 < i.velocities.length) {
              var u = i.velocities.pop(),
                  ...
                  m = u.time - v.time;
              t.velocity = f / m, t.velocity /= 2, Math.abs(t.velocity) < s.freeModeMinimumVelocity && (t.velocity = 0), (150 < m || 300 < B.now() - u.time) && (t.velocity = 0);
            } else t.velocity = 0;
            ...
            if (x && t.once("transitionEnd", function () {
              t.loopFix();
            }), 0 !== t.velocity) g = r ? Math.abs((-w - t.translate) / t.velocity) : Math.abs((w - t.translate) / t.velocity);else if (s.freeModeSticky) return void t.slideToClosest();
            s.freeModeMomentumBounce && E ? (t.updateProgress(y), t.setTransition(g), t.setTranslate(w), t.transitionStart(!0, t.swipeDirection), t.animating = !0, n.transitionEnd(function () {
          ...
          for (var M = 0, z = t.slidesSizesGrid[0], k = 0; k < o.length; k += s.slidesPerGroup) {
            void 0 !== o[k + s.slidesPerGroup] ? h >= o[k] && h < o[k + s.slidesPerGroup] && (z = o[(M = k) + s.slidesPerGroup] - o[k]) : h >= o[k] && (M = k, z = o[o.length - 1] - o[o.length - 2]);
          }
      ...
      if (X.touch || !X.pointerEvents && !X.prefixedPointerEvents) {
        if (X.touch) {
          var n = !("touchstart" !== t.start || !X.passiveListener || !e.passiveListeners) && {
            passive: !0,
            capture: !1
          };
          a.addEventListener(t.start, this.onTouchStart, n), a.addEventListener(t.move, this.onTouchMove, X.passiveListener ? {
            passive: !1,
            capture: r
          } : r), a.addEventListener(t.end, this.onTouchEnd, n);
        }

        (e.simulateTouch && !f.ios && !f.android || e.simulateTouch && !X.touch && f.ios) && (a.addEventListener("mousedown", this.onTouchStart, !1), v.addEventListener("mousemove", this.onTouchMove, r), v.addEventListener("mouseup", this.onTouchEnd, !1));
      } else a.addEventListener(t.start, this.onTouchStart, !1), v.addEventListener(t.move, this.onTouchMove, r), v.addEventListener(t.end, this.onTouchEnd, !1);

      (e.preventClicks || e.preventClicksPropagation) && a.addEventListener("click", this.onClick, !0), this.on(f.ios || f.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", m, !0);
    },
    detachEvents: function detachEvents() {
      ...
      if (X.touch || !X.pointerEvents && !X.prefixedPointerEvents) {
        if (X.touch) {
          var n = !("onTouchStart" !== t.start || !X.passiveListener || !e.passiveListeners) && {
            passive: !0,
            capture: !1
          };
        ...
        (e.simulateTouch && !f.ios && !f.android || e.simulateTouch && !X.touch && f.ios) && (a.removeEventListener("mousedown", this.onTouchStart, !1), v.removeEventListener("mousemove", this.onTouchMove, r), v.removeEventListener("mouseup", this.onTouchEnd, !1));
      } else a.removeEventListener(t.start, this.onTouchStart, !1), v.removeEventListener(t.move, this.onTouchMove, r), v.removeEventListener(t.end, this.onTouchEnd, !1);

      (e.preventClicks || e.preventClicksPropagation) && a.removeEventListener("click", this.onClick, !0), this.off(f.ios || f.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", m);
    }
  },
      w = {
    setBreakpoint: function setBreakpoint() {
      ...
      if (a && (!a || 0 !== Object.keys(a).length)) {
        ...
        if (r && this.currentBreakpoint !== r) {
          ...
          B.extend(this.params, n), B.extend(this, {
    ...
    transition: {
      ...
      transitionStart: function transitionStart(e, t) {
        ...
        if (r || (r = a < i ? "next" : i < a ? "prev" : "reset"), this.emit("transitionStart"), e && i !== a) {
    ...
    classes: {
      addClasses: function addClasses() {
        var t = this.classNames,
            ...
            s = this.$el,
            a = [];
        a.push(i.direction), i.freeMode && a.push("free-mode"), X.flexbox || a.push("no-flexbox"), i.autoHeight && a.push("autoheight"), e && a.push("rtl"), 1 < i.slidesPerColumn && a.push("multirow"), f.android && a.push("android"), f.ios && a.push("ios"), L.isIE && (X.pointerEvents || X.prefixedPointerEvents) && a.push("wp8-" + i.direction), a.forEach(function (e) {
    ...
    images: {
      loadImage: function loadImage(e, t, i, s, a, r) {
        ...
        e.complete && a ? o() : t ? ((n = new N.Image()).onload = o, n.onerror = o, s && (n.sizes = s), i && (n.srcset = i), t && (n.src = t)) : o();
      },
    ...
    function u() {
      ...
      (a = 1 === i.length && i[0].constructor && i[0].constructor === Object ? i[0] : (t = (e = i)[0], e[1])) || (a = {}), a = B.extend({}, a), t && !a.el && (a.el = t), c.call(this, a), Object.keys(x).forEach(function (t) {
      ...
      var n = B.extend({}, y);
      r.useModulesParams(n), r.params = B.extend({}, n, E, a), r.originalParams = B.extend({}, r.params), r.passedParams = B.extend({}, a);
      var o = (r.$ = $)(r.params.el);
      ...
      if (t = o[0]) {
        ...
        var d,
            h,
            p = o.children("." + r.params.wrapperClass);
        return B.extend(r, {
          $el: o,
          el: t,
          $wrapperEl: p,
          ...
          touchEvents: (d = ["touchstart", "touchmove", "touchend"], h = ["mousedown", "mousemove", "mouseup"], X.pointerEvents ? h = ["pointerdown", "pointermove", "pointerup"] : X.prefixedPointerEvents && (h = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), r.touchEventsTouch = {
            start: d[0],
            move: d[1],
            end: d[2]
          ...
          }, X.touch || !r.params.simulateTouch ? r.touchEventsTouch : r.touchEventsDesktop),
          touchEventsData: {
            isTouched: void 0,
            isMoved: void 0,
    ...
    update: function update(e) {
      ...
      var u,
          ...
          f,
          m = t.activeIndex || 0;
      u = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top", f = r ? (v = Math.floor(s / 2) + a, Math.floor(s / 2) + a) : (v = s + (a - 1), a);
      ...
      }), o === g && l === b && !e) return t.slidesGrid !== h && w !== c && t.slides.css(u, w + "px"), void t.updateProgress();
      ...
      var x = [],
          E = [];
      if (e) t.$wrapperEl.find("." + t.params.slideClass).remove();else for (var T = o; T <= l; T += 1) {
      ...
      }), t.$wrapperEl.children(".swiper-slide").css(u, w + "px"), y();
    },
    ...
    on: {
      beforeInit: function beforeInit() {
        if (this.params.virtual.enabled) {
          ...
          B.extend(this.params, e), B.extend(this.originalParams, e), this.virtual.update();
        }
      },
    ...
    handle: function handle(e) {
      ...
      if (s.invert && (a = -a), i.params.freeMode) {
        ...
        if (60 < B.now() - i.mousewheel.lastScrollTime) if (a < 0) {
    ...
    enable: function enable() {
      ...
      var e = this.$el;
      return "container" !== this.params.mousewheel.eventsTarged && (e = $(this.params.mousewheel.eventsTarged)), e.on("mouseenter", this.mousewheel.handleMouseEnter), e.on("mouseleave", this.mousewheel.handleMouseLeave), e.on(G.event, this.mousewheel.handle), this.mousewheel.enabled = !0;
    },
    disable: function disable() {
      if (!G.event) return !1;
      if (!this.mousewheel.enabled) return !1;
      var e = this.$el;
      return "container" !== this.params.mousewheel.eventsTarged && (e = $(this.params.mousewheel.eventsTarged)), e.off(G.event, this.mousewheel.handle), !(this.mousewheel.enabled = !1);
    }
  },
      H = {
    ...
    update: function update() {
      ...
      if (a.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
        ...
        if (this.params.loop ? ((r = Math.ceil((this.activeIndex - this.loopedSlides) / this.params.slidesPerGroup)) > t - 1 - 2 * this.loopedSlides && (r -= t - 2 * this.loopedSlides), s - 1 < r && (r -= s), r < 0 && "bullets" !== this.params.paginationType && (r = s + r)) : r = void 0 !== this.snapIndex ? this.snapIndex : this.activeIndex || 0, "bullets" === a.type && this.pagination.bullets && 0 < this.pagination.bullets.length) {
          var n,
              o,
              l,
              d = this.pagination.bullets;
          if (a.dynamicBullets && (this.pagination.bulletSize = d.eq(0)[this.isHorizontal() ? "outerWidth" : "outerHeight"](!0), i.css(this.isHorizontal() ? "width" : "height", this.pagination.bulletSize * (a.dynamicMainBullets + 4) + "px"), 1 < a.dynamicMainBullets && void 0 !== this.previousIndex && (this.pagination.dynamicBulletIndex += r - this.previousIndex, this.pagination.dynamicBulletIndex > a.dynamicMainBullets - 1 ? this.pagination.dynamicBulletIndex = a.dynamicMainBullets - 1 : this.pagination.dynamicBulletIndex < 0 && (this.pagination.dynamicBulletIndex = 0)), n = r - this.pagination.dynamicBulletIndex, l = ((o = n + (Math.min(d.length, a.dynamicMainBullets) - 1)) + n) / 2), d.removeClass(a.bulletActiveClass + " " + a.bulletActiveClass + "-next " + a.bulletActiveClass + "-next-next " + a.bulletActiveClass + "-prev " + a.bulletActiveClass + "-prev-prev " + a.bulletActiveClass + "-main"), 1 < i.length) d.each(function (e, t) {
            var i = $(t),
                s = i.index();
          ...
          });else if (d.eq(r).addClass(a.bulletActiveClass), a.dynamicBullets) {
            for (var h = d.eq(n), p = d.eq(o), c = n; c <= o; c += 1) {
              d.eq(c).addClass(a.bulletActiveClass + "-main");
            }
    ...
    setTranslate: function setTranslate() {
      if (this.params.scrollbar.el && this.scrollbar.el) {
        var e = this.scrollbar,
            ...
            l = s,
            d = (a - s) * i;
        t ? 0 < (d = -d) ? (l = s - d, d = 0) : a < -d + s && (l = a + d) : d < 0 ? (l = s + d, d = 0) : a < d + s && (l = a - d), this.isHorizontal() ? (X.transforms3d ? r.transform("translate3d(" + d + "px, 0, 0)") : r.transform("translateX(" + d + "px)"), r[0].style.width = l + "px") : (X.transforms3d ? r.transform("translate3d(0px, " + d + "px, 0)") : r.transform("translateY(" + d + "px)"), r[0].style.height = l + "px"), o.hide && (clearTimeout(this.scrollbar.timeout), n[0].style.opacity = 1, this.scrollbar.timeout = setTimeout(function () {
    ...
    updateSize: function updateSize() {
      if (this.params.scrollbar.el && this.scrollbar.el) {
        ...
        var s,
            ...
            n = r * (a / this.size);
        s = "auto" === this.params.scrollbar.dragSize ? a * r : parseInt(this.params.scrollbar.dragSize, 10), this.isHorizontal() ? t[0].style.width = s + "px" : t[0].style.height = s + "px", i[0].style.display = 1 <= r ? "none" : "", this.params.scrollbarHide && (i[0].style.opacity = 0), B.extend(e, {
          trackSize: a,
          divider: r,
          moveDivider: n,
          dragSize: s
    ...
    enableDraggable: function enableDraggable() {
      if (this.params.scrollbar.el) {
        var e = this.scrollbar,
            ...
            s = this.params,
            a = e.$el[0],
            r = !(!X.passiveListener || !s.passiveListener) && {
          passive: !1,
          capture: !1
        },
            n = !(!X.passiveListener || !s.passiveListener) && {
          passive: !0,
          capture: !1
        };
        X.touch || !X.pointerEvents && !X.prefixedPointerEvents ? (X.touch && (a.addEventListener(t.start, this.scrollbar.onDragStart, r), a.addEventListener(t.move, this.scrollbar.onDragMove, r), a.addEventListener(t.end, this.scrollbar.onDragEnd, n)), (s.simulateTouch && !f.ios && !f.android || s.simulateTouch && !X.touch && f.ios) && (a.addEventListener("mousedown", this.scrollbar.onDragStart, r), v.addEventListener("mousemove", this.scrollbar.onDragMove, r), v.addEventListener("mouseup", this.scrollbar.onDragEnd, n))) : (a.addEventListener(i.start, this.scrollbar.onDragStart, r), v.addEventListener(i.move, this.scrollbar.onDragMove, r), v.addEventListener(i.end, this.scrollbar.onDragEnd, n));
      }
    },
    disableDraggable: function disableDraggable() {
      if (this.params.scrollbar.el) {
        ...
        X.touch || !X.pointerEvents && !X.prefixedPointerEvents ? (X.touch && (a.removeEventListener(t.start, this.scrollbar.onDragStart, r), a.removeEventListener(t.move, this.scrollbar.onDragMove, r), a.removeEventListener(t.end, this.scrollbar.onDragEnd, n)), (s.simulateTouch && !f.ios && !f.android || s.simulateTouch && !X.touch && f.ios) && (a.removeEventListener("mousedown", this.scrollbar.onDragStart, r), v.removeEventListener("mousemove", this.scrollbar.onDragMove, r), v.removeEventListener("mouseup", this.scrollbar.onDragEnd, n))) : (a.removeEventListener(i.start, this.scrollbar.onDragStart, r), v.removeEventListener(i.move, this.scrollbar.onDragMove, r), v.removeEventListener(i.end, this.scrollbar.onDragEnd, n));
      }
    },
    init: function init() {
      if (this.params.scrollbar.el) {
        ...
        0 === a.length && (a = $('<div class="' + this.params.scrollbar.dragClass + '"></div>'), s.append(a)), B.extend(e, {
          $el: s,
          el: s[0],
          $dragEl: a,
          dragEl: a[0]
    ...
    setTransform: function setTransform(e, t) {
      ...
      if (n || o ? (n = n || "0", o = o || "0") : this.isHorizontal() ? (n = r, o = "0") : (o = r, n = "0"), n = 0 <= n.indexOf("%") ? parseInt(n, 10) * t * a + "%" : n * t * a + "px", o = 0 <= o.indexOf("%") ? parseInt(o, 10) * t + "%" : o * t + "px", null != d) {
    ...
    setTranslate: function setTranslate() {
      ...
      e.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function (e, t) {
        ...
        var i = t.progress;
        1 < s.params.slidesPerGroup && "auto" !== s.params.slidesPerView && (i += Math.ceil(e / 2) - a * (r.length - 1)), i = Math.min(Math.max(i, -1), 1), $(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function (e, t) {
    ...
    onGestureChange: function onGestureChange(e) {
      ...
      s.$imageEl && 0 !== s.$imageEl.length && (X.gestures ? this.zoom.scale = e.scale * i.currentScale : i.scale = s.scaleMove / s.scaleStart * i.currentScale, i.scale > s.maxRatio && (i.scale = s.maxRatio - 1 + Math.pow(i.scale - s.maxRatio + 1, .5)), i.scale < t.minRatio && (i.scale = t.minRatio + 1 - Math.pow(t.minRatio - i.scale + 1, .5)), s.$imageEl.transform("translate3d(0,0,0) scale(" + i.scale + ")"));
    },
    ...
    enable: function enable() {
      ...
      if (!e.enabled) {
        ...
        X.gestures ? (this.$wrapperEl.on("gesturestart", ".swiper-slide", e.onGestureStart, t), this.$wrapperEl.on("gesturechange", ".swiper-slide", e.onGestureChange, t), this.$wrapperEl.on("gestureend", ".swiper-slide", e.onGestureEnd, t)) : "touchstart" === this.touchEvents.start && (this.$wrapperEl.on(this.touchEvents.start, ".swiper-slide", e.onGestureStart, t), this.$wrapperEl.on(this.touchEvents.move, ".swiper-slide", e.onGestureChange, t), this.$wrapperEl.on(this.touchEvents.end, ".swiper-slide", e.onGestureEnd, t)), this.$wrapperEl.on(this.touchEvents.move, "." + this.params.zoom.containerClass, e.onTouchMove);
      }
    },
    disable: function disable() {
      var e = this.zoom;
    ...
    load: function load() {
      ...
      });else if (1 < o) for (var h = e; h < e + o; h += 1) {
        l(h) && s.lazy.loadInSlide(h);
      } else s.lazy.loadInSlide(e);
      if (n.loadPrevNext) if (1 < o || n.loadPrevNextAmount && 1 < n.loadPrevNextAmount) {
        for (var p = n.loadPrevNextAmount, c = o, u = Math.min(e + c + Math.max(p, c), a.length), v = Math.max(e - Math.max(c, p), 0), f = e + o; f < u; f += 1) {
          l(f) && s.lazy.loadInSlide(f);
        }
    ...
    setTransition: function setTransition(t, e) {
      ...
      if (Array.isArray(a)) for (i = 0; i < a.length; i += 1) {
        a[i] !== e && a[i] instanceof T && r(a[i]);
      } else a instanceof T && e !== a && r(a);
    }
  },
      j = {
    ...
    init: function init() {
      if (this.params.history) {
        ...
        var e = this.history;
        e.initialized = !0, e.paths = K.getPathValues(), (e.paths.key || e.paths.value) && (e.scrollToSlide(0, e.paths.value, this.params.runCallbacksOnInit), this.params.history.replaceState || N.addEventListener("popstate", this.history.setHistoryPopState));
      }
    },
    destroy: function destroy() {
    ...
    init: function init() {
      if (!(!this.params.hashNavigation.enabled || this.params.history && this.params.history.enabled)) {
        ...
        this.params.hashNavigation.watchState && $(N).on("hashchange", this.hashNavigation.onHashCange);
      }
    },
    destroy: function destroy() {
      this.params.hashNavigation.watchState && $(N).off("hashchange", this.hashNavigation.onHashCange);
    }
  },
      _ = {
    run: function run() {
    ...
    setTranslate: function setTranslate() {
      var e,
          ...
          p = 0;
      l.shadow && (d ? (0 === (e = i.find(".swiper-cube-shadow")).length && (e = $('<div class="swiper-cube-shadow"></div>'), i.append(e)), e.css({
        height: a + "px"
      ...
      for (var c = 0; c < s.length; c += 1) {
        ...
        if (g <= 1 && -1 < g && (p = 90 * v + 90 * g, n && (p = 90 * -v - 90 * g)), u.transform(x), l.slideShadows) {
          ...
          0 === E.length && (E = $('<div class="swiper-slide-shadow-' + (d ? "left" : "top") + '"></div>'), u.append(E)), 0 === T.length && (T = $('<div class="swiper-slide-shadow-' + (d ? "right" : "bottom") + '"></div>'), u.append(T)), E.length && (E[0].style.opacity = Math.max(-g, 0)), T.length && (T[0].style.opacity = Math.max(g, 0));
        }
      }
      ...
      if (i.css({
        ...
        var S = Math.abs(p) - 90 * Math.floor(Math.abs(p) / 90),
            ...
            z = l.shadowScale / C,
            k = l.shadowOffset;
        e.transform("scale3d(" + M + ", 1, " + z + ") translate3d(0px, " + (r / 2 + k) + "px, " + -r / 2 / z + "px) rotateX(-90deg)");
      }
      var P = L.isSafari || L.isUiWebView ? -o / 2 : 0;
    ...
    setTranslate: function setTranslate() {
      for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
        ...
        if (this.isHorizontal() ? t && (r = -r) : (l = o, n = -r, r = o = 0), s[0].style.zIndex = -Math.abs(Math.round(a)) + e.length, this.params.flipEffect.slideShadows) {
    ...
    setTranslate: function setTranslate() {
      for (var e = this.width, t = this.height, i = this.slides, s = this.$wrapperEl, a = this.slidesSizesGrid, r = this.params.coverflowEffect, n = this.isHorizontal(), o = this.translate, l = n ? e / 2 - o : t / 2 - o, d = n ? r.rotate : -r.rotate, h = r.depth, p = 0, c = i.length; p < c; p += 1) {
        var u = i.eq(p),
            v = a[p],
            f = (l - u[0].swiperSlideOffset - v / 2) / v * r.modifier,
            m = n ? d * f : 0,
            g = n ? 0 : d * f,
            b = -h * Math.abs(f),
            w = n ? 0 : r.stretch * f,
        ...
        if (u.transform(x), u[0].style.zIndex = 1 - Math.abs(Math.round(f)), r.slideShadows) {
          ...
          0 === E.length && (E = $('<div class="swiper-slide-shadow-' + (n ? "left" : "top") + '"></div>'), u.append(E)), 0 === T.length && (T = $('<div class="swiper-slide-shadow-' + (n ? "right" : "bottom") + '"></div>'), u.append(T)), E.length && (E[0].style.opacity = 0 < f ? f : 0), T.length && (T[0].style.opacity = 0 < -f ? -f : 0);
        }
      }
    ...
    on: {
      ...
      click: function click(e) {
        var t = this.navigation,
            i = t.$nextEl,
            s = t.$prevEl;
        !this.params.navigation.hideOnClick || $(e.target).is(s) || $(e.target).is(i) || (i && i.toggleClass(this.params.navigation.hiddenClass), s && s.toggleClass(this.params.navigation.hiddenClass));
      }
    }
  }, {
    name: "pagination",
